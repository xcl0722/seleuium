...
while (i < 100000000):
      ...
      time.sleep(6)
      # driver.find_element_by_xpath("//div/div[1]/div/div/div[2]/ul/li[2]/span[2]").click()
      # time.sleep(5)
      driver.find_element_by_css_selector(" div.navbar-content > ul > li.kc-menu-item.is-active > span:nth-child(2)").click()  # 切换到接警tab
      time.sleep(5)
      i = i + 1
print("1亿次新建警情立案结束了")
driver.quit()
