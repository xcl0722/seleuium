...
time.sleep(3)
driver.find_element_by_xpath("//div/div[2]/div/form/div[2]/div/div/input").send_keys("19951235678")#报警电话
time.sleep(2)
driver.find_element_by_xpath("//div/form/div[3]/div/div/input").send_keys("许多多")#报警人姓名
time.sleep(2)
...
time.sleep(4)
driver.find_element_by_xpath("//div[2]/div/div[2]/div/div[3]/span").click()#接警页直接调派
time.sleep(3)
